...
const { getMarkdownSection, getHighlights, getLeftoverSections, getInstallationSteps, getTagline } = require('../utils/markdown')
...
module.exports = async(backend) => {
  ...
  return {
    ...
    readmeLeftover: await getLeftoverSections(
      readme,
      [
        'Introduction',
        'Motivation',
